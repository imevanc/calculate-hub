export const PERCENTAGE_CALCULATOR = {
    ...
    description: "Calculate percentages, increases, decreases, and differences with ease",
    ...
    tableOfContents: [
        { id: 'basics', title: 'Understanding Percentages', subsections: ['What are percentages?', 'Basic calculations', 'Real-world examples'] },
        { id: 'types', title: 'Types of Percentage Calculations', subsections: ['Simple percentages', 'Percentage change', 'Compound percentages'] },
        { id: 'applications', title: 'Practical Applications', subsections: ['Finance and investing', 'Statistics and data', 'Everyday scenarios'] },
        { id: 'advanced', title: 'Advanced Concepts', subsections: ['Percentage points', 'Compound interest', 'Error margins'] },
        { id: 'tips', title: 'Tips and Tricks', subsections: ['Mental math shortcuts', 'Common mistakes', 'Quick estimation methods'] }
    ],
